...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    var statusBarStyle: SSAStatusBarStyle = .black
    @IBInspectable var statusBarStyleValue: Int {
        get {
            return statusBarStyle.rawValue
        }
        set {
            statusBarStyle = SSAStatusBarStyle(rawValue: newValue) ?? .black
        }
    }
    ...
    var panDirection: SSASideMenuPanDirection = .edge
    @IBInspectable var panDirectionValue: Int {
        get{
            return panDirection.rawValue
        }
        set{
            panDirection = SSASideMenuPanDirection(rawValue: newValue) ?? .edge
        }
    }
    var type: SSASideMenuType = .scale
    @IBInspectable var typeValue: Int {
        ...
        set{
            type = SSASideMenuType(rawValue: newValue) ?? .scale
        }
    }
